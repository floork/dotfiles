...
keymap.set("n", "<leader>sr", ":vertical resize +5<CR>", { desc = "Increase window width" }) -- increase window width
keymap.set("n", "<leader>sl", ":vertical resize -5<CR>", { desc = "Decrease window width" }) -- decrease window width
...
-- netrw
-- keymap.set("n", "<leader>ee", "<cmd>Lexplore<CR>", { desc = "Open netrw" }) -- open netrw
